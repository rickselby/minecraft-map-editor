...
class IDs
{
    ...
    static public $list = [
        ...
        Ref::MELON                => [103, 0],
        Ref::PUMPKIN_STEM         => [104, 0, 'Stem'],
        Ref::MELON_STEM           => [105, 0, 'Stem'],
        ...
        Ref::REDSTONE_COMPARATOR_OFF       => [149, 0, 'RedstoneComparator'],
        Ref::REDSTONE_COMPARATOR_ON        => [150, 0, 'RedstoneComparator'],
